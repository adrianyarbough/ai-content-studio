...
window.FloodifyPromptEngineer = class FloodifyPromptEngineer {
  ...
  showGalleryImage(id, url, prompt) {
    ...
    wrapper.className = 'max-w-4xl w-full bg-gray-800 rounded-lg overflow-hidden'
    ...
    downloadBtn.className = 'px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg'
    downloadBtn.innerHTML = '<i class="fas fa-download mr-2"></i>Download'
    downloadBtn.addEventListener('click', () => this.downloadImage(url, id))

    const generateBtn = document.createElement('button')
    generateBtn.className = 'px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg'
    generateBtn.innerHTML = '<i class="fas fa-video mr-2"></i>Generate Video'
    generateBtn.addEventListener('click', () => this.generateVideoFromImage(url, id))

    const closeBtn = document.createElement('button')
    closeBtn.className = 'px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded-lg'
  ...
  showGalleryVideo(videoUrl, prompt) {
    ...
    downloadBtn.addEventListener('click', () => this.downloadVideo(videoUrl))

    const openBtn = document.createElement('button')
    openBtn.className = 'px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg'
    openBtn.innerHTML = '<i class="fas fa-external-link-alt mr-2"></i>Open in New Tab'
  ...
  populateThemeSelector() {
    ...
    // Build options safely to avoid HTML injection
    selector.innerHTML = ''
    ...
    themes.forEach((theme) => {
      ...
      option.textContent = `${theme.theme} - ${theme.model} (${passRate}% pass) - ${status}${isOutlier}`
